...
## Hand-in and Exam.
1. Create a GitHub repo for all your work in this course and link to it [Link](https://docs.google.com/spreadsheets/d/1IKFYbYwqUlZ0sUaFcLaxl154NgoaRl0g57yY6k3ipo0/edit?usp=sharing)
...
- The frontend could have role-based routing (admin, user, etc. only visible to logged in users with the correct role).

## Exam details
- The exam is primarily based on your group semester project.
- The exam is a 30 min **individual** oral exam with no preparation time based on your code (primarily the semester project)
